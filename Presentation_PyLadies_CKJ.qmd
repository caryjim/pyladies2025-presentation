...
-  Demonstrate how stratified random sampling is used to identify subgroups
-  Post-stratification weights are applied to correct unequal representation
...
Synthetic respondents data based on a survey distributed to the participants in the sampled dataset.
