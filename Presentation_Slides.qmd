...
## But Wait...There's Re-coding to Do! {.smaller}
...
respondents_data[['Q1_Gender', 'Q2_Race', 'Q3_AgeGroup', 'Weight']].head(3).round(3)
```
...
#| echo: true
# Apply the weight calculation to each row in the respondents_data DataFrame
respondents_data['Q4_with_weights'] = respondents_data['Q4_Traffic_Accidents'] * respondents_data['Weight']
...
respondents_data[['Q4_Traffic_Accidents', 'Weight', 'Q4_with_weights']].head(3).round(3)
```
